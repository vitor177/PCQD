...
def total_xplot3(variavel1, variavel2, variavel3, data, numfigura, titulo, titulo_var, diafinal, mes, ano, limsy, limiy, undy, tamfont, cor1, cor2, cor3, nome_arquivo):
    ...
    # primeiro subplot
    axs[0].plot(datap1, variavelp1, color=cor1, linewidth=0.5)  # Linha azul mais fina
    axs[0].plot(datap1, variavel2p1, '--x', color=cor2, linewidth=1.5)
    axs[0].plot(datap1, variavel3p1, '--x', color=cor3, linewidth=1.5)
    ...
    # segundo subplot
    axs[1].plot(datap2, variavelp2, color=cor1, linewidth=0.5)  # Linha azul mais fina
    axs[1].plot(datap2, variavel2p2, '--x', color=cor2, linewidth=1.5)
    axs[1].plot(datap2, variavel3p2, '--x', color=cor3, linewidth=1.5)
    ...
    # terceiro subplot
    axs[2].plot(datap3, variavelp3, color=cor1, linewidth=0.5)  # Linha azul mais fina
    axs[2].plot(datap3, variavel2p3, '--x', color=cor2, linewidth=1.5)
    axs[2].plot(datap3, variavel3p3, '--x', color=cor3, linewidth=1.5)
