...
def total_xplot3x(variavel1, variavel2, variavel3, data, num_figura, titulo, titulo_var, dia_final, mes, ano, lim_sy, lim_iy, und_y, tam_font, cor1, cor2, cor3, nome_arquivo):
